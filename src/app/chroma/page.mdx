export const metadata = {
  title: "DeployPlex's Chroma",
  description:
    'Learn the benefits and how to use DeployPlex Chroma',
}

# Storage - Chroma
DeployPlex's managed [Chroma](https://www.trychroma.com/) simplifies the management of your embeddings database through zero-config.
...
## Getting started
Create a new Chroma database from [DeployPlex storage](https://deployplex.com/storage), select new VectorDB,
...
```
Alternatively you can use [this template](https://github.com/deployplex/deployplex/tree/main/examples/ai-native-api) to get started, if you don't know where to start.
