...
```
Alternatively you can use [this template](https://github.com/doseiai/dosei/tree/main/examples/ai-native-api) to get started, if you don't know where to start.
